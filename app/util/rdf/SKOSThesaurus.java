...
//		System.out.println(query);
	...
	public String getEnglishPrefLabel(String concept){
		return getPrefLabel(concept, "en");
	}
	
	public String getPrefLabel(String concept, String lang){
		String select = "SELECT (str(?prefLabel) as ?label) \n";
...
//		System.out.println(query);
	...
	public static void main(String[] args){
		...
		String conceptScheme = "http://partage.vocnet.org/MicroObjectTypes";//many top concepts
		int limit = 0;
		int offset = 0;
		String like = null;
//		like = "Art";
...
//		System.out.println(skos.getPrefLabel("http://bib.arts.kuleuven.be/photoVocabulary/31230","fr"));
...
//		System.out.println(skos.getLike());

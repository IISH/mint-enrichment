...
public class MINTThesaurus extends SKOSThesaurus {
	...
	public List<Map<String, String>> getTopConcepts(String rangeOfProperyAsValue) {
		String select = "SELECT distinct (str(?conceptWithLang) as ?concept) (str(?prefLabelLang) as ?label) (str(?prefLabel) as ?enlabel) (str(?prefLabelNoLang) as ?labelNolang) \n";
		String collectionsStr = initCollections();
		String otherLangs = otherLangs("conceptWithLang", "prefLabel");
		String condition = "	{\n" +
				"		{\n" +
				"			?conceptID skos:topConceptOf <"+conceptScheme+"> ;\n" +
				"			<"+rangeOfProperyAsValue+"> ?conceptWithlang ;\n" +
				...
				"			?conceptID <"+rangeOfProperyAsValue+"> ?conceptWithLang .\n" +
							otherLangs +
				"		}\n" +
				"		UNION\n" +
				"		{\n" +
				...
				"			skos:inScheme <"+conceptScheme+">.\n" +
							otherLangs +
				"			MINUS { ?conceptID skos:broaderTransitive ?o . ?conceptID <"+rangeOfProperyAsValue+"> ?conceptWithLang . ?o skos:inScheme <"+conceptScheme+"> }\n" +
				"			MINUS { ?conceptID skos:broader ?o1 . ?conceptID <"+rangeOfProperyAsValue+"> ?conceptWithLang . ?o1 skos:inScheme <"+conceptScheme+"> } \n" +
				"			MINUS { ?s skos:narrowerTransitive ?conceptID . ?conceptID <"+rangeOfProperyAsValue+"> ?conceptWithLang . ?s skos:inScheme <"+conceptScheme+"> }\n" +
				"			MINUS { ?s1 skos:narrower ?conceptID . ?conceptID <"+rangeOfProperyAsValue+"> ?conceptWithLang . ?s1 skos:inScheme <"+conceptScheme+"> } \n" +
				"		}\n" +
				"	}\n";
	...
	public List<Map<String, String>> getConcepts(String rangeOfProperyAsValue) {
		String select = "SELECT distinct (str(?conceptWithLang) as ?concept) (str(?prefLabelLang) as ?label) (str(?prefLabel) as ?enlabel) (str(?prefLabelNoLang) as ?labelNolang) \n";
		String select2 = "SELECT distinct (str(?conceptWithLang) as ?concept) (str(?prefLabel) as ?label) (str(?prefLabelLang) as ?enlabel) (str(?prefLabelNoLang) as ?labelNolang) \n";
		String collectionsStr = initCollections();
		String otherLangs = otherLangs("conceptWithLang", "prefLabel");
		String condition = 		"{\n" +
